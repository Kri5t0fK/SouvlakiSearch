...
public partial class GeneticAlgorithm
{
    ...
    public int GenerationSize
    {
        ...
        { 
            ...
            { 
                throw new ArgumentException("Generation size must be an even number greater than 0!"); 
            }
    ...
    public int SelectionSize
    {
        ...
        set 
        { 
            if (value >= this.generationSize || value % 2 == 1 || value <= 0) 
            {
                throw new ArgumentException("Selection size must be an even number in range (0, GenerationSize)");
            }
            selectionSize = value; 
        }
    }
    ...
    public int MutationChance
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentException("Mutation chance must be in range <0, 100>");
            }
    ...
    public int MaxIterations
    {
        ...
        set
        {
            if (value <= 0)
            {
                throw new ArgumentException("Algorithm must run for at least one iteration!");
            }
            maxIterations = value;
        }
    }
    private int lastElementsToCheck;
    public int LastElementsToCheck
    {
        get { return lastElementsToCheck; }
        set
        {
            if (value <= 0 || value >= this.maxIterations)
            {
                throw new ArgumentException("Value of field LastElementsToCheck must be in range (0, MaxIterations)");
            }
            lastElementsToCheck = value;
        }
    }
